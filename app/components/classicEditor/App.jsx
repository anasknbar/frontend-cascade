 ...
 */
const LICENSE_KEY = 'd1lwVGhIMjRrcFBnWndnY3V4bnBFejhoZEZYbGpETzAyQzNGWWVBM3d2bCtmUGVaYWZjOTR1ZGVmTDlzT3c9PS1NakF5TkRFeE1EYz0=';
const CKBOX_TOKEN_URL = 'https://120291.cke-cs.com/token/dev/07bb406e156e542de6b8ac7c449f42791a951c30298170d34593938b18bd?limit=10';
...
export default function App() {
  ...
  const [isLayoutReady, setIsLayoutReady] = useState(false);
	...
	const editorConfig = {
		...
		balloonToolbar: ['bold', 'italic','underline','|', 'link', 'insertImage', '|', 'bulletedList', 'numberedList'],
		ckbox: {
